...
export const SAD_GAMES: Record<string, SADGameMeta> = {
  sdlc_sorter: {
    ...
    howTo: "Drag the shuffled phase cards into the correct order on the timeline.",
    icon: Layers,
  ...
  req_sorter: {
    ...
    howTo: "Read each requirement card and tap the bucket where it belongs: Functional or Non-Functional.",
    icon: Boxes,
  ...
  usecase_builder: {
    ...
    howTo: "For each use case, tap the actor who is responsible for it in the scenario.",
    icon: Workflow,
    color: "text-cyan-300",
  ...
  erd_doctor: {
    ...
    howTo: "Read each broken relationship and pick the correct cardinality to fix the diagram.",
    icon: Database,
  ...
  dfd_detective: {
    ...
    howTo: "A flow is missing! Pick the correct FROM and TO node to complete the diagram.",
    icon: Activity,
    color: "text-pink-300",
  ...
  sequence_stacker: {
    ...
    howTo: "Re-order the scrambled messages so the scenario flows correctly from top to bottom.",
    icon: ListOrdered,
